...
fun LoginScreen(
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = Color.White) {
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(16.dp)) // Espacio entre texto y logo

            Image(
                painter = painterResource(id = R.drawable.logo),
                contentDescription = "Logo del Foro",
                modifier = Modifier.size(150.dp) // Ajusta el tamaño del logo como necesites
            )
